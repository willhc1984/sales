...
public class UserResource {
	...
	@GetMapping
	public ResponseEntity<Page<UserModel>> buscarTodos(@PageableDefault(page = 0, size = 10,
		    direction = Sort.Direction.ASC)	Pageable pageable){
		return ResponseEntity.status(HttpStatus.OK).body(userService.buscarTodos(pageable));
	}
